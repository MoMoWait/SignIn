...
/**
 * 创建签到信息异步任务块
 * Created by GaoFei on 2016/3/31.
 */
public class CreateSignInfoTask extends AsyncTask<String, Integer, Integer>{
    public static final String TAG = CreateSignInfoTask.class.getSimpleName();
    ...
    public CreateSignInfoTask(CallBack callBack){
    ...
    protected Integer doInBackground(String... params) {
        ...
        reqParams.put("course", params[0]);
        reqParams.put("persons", params[1]);
        reqParams.put("startTime", params[2]);
        reqParams.put("endTime", params[3]);
        try {
            mJsonResult = NetService.request("CreateSignInfoService", reqParams);
